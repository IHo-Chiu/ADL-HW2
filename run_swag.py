...
def main():
    ...
    def preprocess_function(examples):
        ...
        second_sentences = [[context_json[idx] for idx in paragraphs] for paragraphs in examples[paragraphs_name]]
        ...
        if not training_args.do_predict:
            tokenized_inputs["labels"] = [paragraphs.index(examples[relevant_name][i]) for i, paragraphs in enumerate(examples[paragraphs_name])]
    ...
    if training_args.do_predict:
        ...
        for i, pred in enumerate(predictions):
            output_json.append({
                ...
                'question': raw_datasets['test']['question'][i],
                'relevant': raw_datasets['test']['paragraphs'][i][pred]
            })
